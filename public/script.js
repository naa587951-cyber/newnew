...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const closeNotifBtn = document.getElementById("close-toast-btn");
  if (closeNotifBtn && notificationToast) {
    closeNotifBtn.addEventListener("click", () => {
      notificationToast.classList.add("toast-hidden");
      clearTimeout(notifTimeout);
      setTimeout(showNextNotification, 25000);
    });
  }

  setTimeout(showNextNotification, 3000);

  // Bottom Navigation tabs and smooth scroll
